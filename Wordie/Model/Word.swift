...
extension Word: WWSQLite3Manager.SchemeDelegate {
    ...
    static func structure() -> [WWSQLite3Manager.SchemeColumn] {
        [
            ...
            (key: "phonetic", type: .TEXT(attribute: (isNotNull: true, isNoCase: true, isUnique: true), defaultValue: nil)),
            (key: "chinese", type: .TEXT(attribute: (isNotNull: true, isNoCase: true, isUnique: true), defaultValue: nil)),
